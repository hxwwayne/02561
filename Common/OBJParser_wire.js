...
OBJDoc.prototype.getDrawingInfo = function () {
  // Create arrays for vertex coordinates, normals, colors, barycentric coordinates and indices
  var numIndices = 0;
  ...
  var barycoords = new Float32Array(numVertices * 3);
  ...
  for (var i = 0; i < this.objects.length; i++) {
    ...
    for (var j = 0; j < object.faces.length; j++) {
      ...
      for (var k = 0; k < face.vIndices.length; k++) {
        ...
        vertices[index_indices * 4 + 0] = vertex.x;
        vertices[index_indices * 4 + 1] = vertex.y;
        vertices[index_indices * 4 + 2] = vertex.z;
        ...
        if (nIdx >= 0) {
          ...
          normals[index_indices * 4 + 0] = normal.x;
          normals[index_indices * 4 + 1] = normal.y;
          normals[index_indices * 4 + 2] = normal.z;
        ...
        barycoords[index_indices * 3 + 0] = k % 3 == 0 ? 1 : 0;
        barycoords[index_indices * 3 + 1] = k % 3 == 1 ? 1 : 0;
        barycoords[index_indices * 3 + 2] = k % 3 == 2 ? 1 : 0;
        index_indices++;
      }
    }
  }

  return new DrawingInfo(vertices, normals, colors, barycoords, indices);
}
...
// DrawInfo Object
//------------------------------------------------------------------------------
var DrawingInfo = function (vertices, normals, colors, barycoords, indices) {
